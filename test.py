...
fields = {
    ...
    "School Information": full_data_soup.find(id="report_R272557515384942239"),
    "SQ Feet": full_data_soup.find(id="P5_RES_SQ_FT_FIN_LIV"),
    "Year Built": full_data_soup.find(id="P5_RES_YEAR_BUILT"),
    "Residential Style": full_data_soup.find(id="P5_RES_STYLE"),
    "Air Conditioner": full_data_soup.find(id="P5_RES_AIR_COND"),
    "Bedroom Count": full_data_soup.find(id="P5_RES_BEDROOMS"),
    "Full Bathrooms": full_data_soup.find(id="P5_RES_FULL_BATH"),
    "Half Bathrooms": full_data_soup.find(id="P5_RES_HALF_BATH"),
